...
//    private static UsersDaoImpl us;

    public static void main(String[] args) throws DaoException {

//        ApplicationContext context = new ClassPathXmlApplicationContext("/appContext.xml");
//
//        UsersDaoImpl us = (UsersDaoImpl) context.getBean("usersDao");
//
//
//
//
...
//        /**RestaurantDto*/
//
//        RestaurantsDaoImpl rest = (RestaurantsDaoImpl) context.getBean("restaurantsDao");
//
...
//        /**AdvertisementDto*/
//
//        AdvertisementsDaoImpl adv = (AdvertisementsDaoImpl) context.getBean("advertisementsDao");
//
